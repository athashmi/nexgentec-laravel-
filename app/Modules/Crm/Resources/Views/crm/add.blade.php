                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group col-lg-6">
                                                 ...
                                                 <div class="form-group col-lg-6">
                                                    ...
                                                    {!! Form::input('text','phone',null, ['placeholder'=>"Main phone",'class'=>"form-control dt_mask",'id'=>'dt_mask', 'data-mask'=>'','data-inputmask'=> '"mask": "(999) 999-9999"']) !!} 
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-group col-lg-6">
                                                    <label>Customer since</label>
                                                     {!! Form::input('text','customer_since',null, ['placeholder'=>"Customer since",'class'=>"form-control datepicker",'data-date-format'=>"$date_format->value"]) !!}
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="form-group col-lg-6">
                                ...
                                <section>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group col-lg-5">
                                            ...
                                            {!! Form::select('service_type_id', $service_types,'',['class'=>'form-control multiselect required','placeholder' => 'Pick a service type','onChange'=>'dynamic_data(this.value);'])!!}
                                    ...
                                    <div class="col-lg-4" id="rates" style="display:none">
                                        ...
                                        <div class="form-group col-lg-12">
                                            ...
                                            {!! Form::select('default_rate', $def_rates,'',['class'=>'form-control multiselect','id'=>'default_rate','placeholder'=>'Pick a default rate'])!!}
                                            
                                        </div>
                                        <div class="form-group col-lg-12">
                                            <label>Additional Rates</label>
                                            <?php $additional_rates = [];?>
                                             {!! Form::select('additional_rates[]', $def_rates,'',['class'=>'form-control multiselect','id'=>'additional_rate','multiple'=>''])!!}
                                     ...
                                     <div class="form-group col-lg-12" id="location_inputs">
                                        ...
                                        <div class="form-group col-lg-6">
                                           ...
                                           {{--  {!! Form::input('text','country',null, ['placeholder'=>"Country",'class'=>"form-control",'id'=>'country']) !!} --}}
                                             ...
                                             {!! Form::select('country', $countries,'',['class'=>'form-control multiselect','id'=>'cntry','placeholder' => 'Pick a Country'])!!}
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label>State</label>
                                ...
                                <section>
                                     <div class="form-group col-lg-12" id="contact_inputs">
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            {!! Form::input('text','contact_mobile',null, ['placeholder'=>"Mobile Phone",'class'=>"form-control dt_mask", 'data-mask'=>'','data-inputmask'=> '"mask": "+1(999) 999-9999"']) !!}
                                        </div>
