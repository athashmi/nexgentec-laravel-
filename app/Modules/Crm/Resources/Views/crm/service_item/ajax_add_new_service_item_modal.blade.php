            ...
            <input type="hidden" name="customer_id_new_service_item" value="">
                    ...
                    <div class="col-lg-4" id="rates" style="display:none">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            {!! Form::select('default_rate', $rates,'',['class'=>'form-control multiselect','id'=>'default_rate'])!!}
          ...
          success: function(response){
            if(response.success){
             ...
             // $('#cntct_msg_div').removeClass('alert-danger').addClass('alert-success').show();
              ...
              //$('#service_item_data_'+service_item_id).html(response.html_content_srvce_item);
              //refresh location contacts
             //$('#service_item_'+service_item_id).find('.panel-title').children('a').text(response.service_item_title);
               alert_hide(); 
