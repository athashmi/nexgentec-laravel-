      ...
      <div class="modal-body">
        <form id="priority_status_form">
            ...
            <div class="form-group col-lg-6">
                ...
                <?php  $statuses = ['new'=>'New',
                                    'open'=>'Open',
                                    'pending'=>'Pending',
                                    'closed'=>'Closed'];
                                    ?>
                 {!! Form::select('status',$statuses,$ticket->status,['class'=>'form-control multiselect','placeholder' => 'Change Status'])!!}
            </div>
             <div class="col-lg-12"> 
...
@parent
 ...
 //console.log(response.assigned_users); 
                ...
                $('#priority').html('<button type="button" class="btn '+response.btn_class_priority+'  btn-sm"><span>'+response.ticket.priority+'</span></button><a class="pull-right btn btn-lg" href="javascript:;" data-target="#modal-edit-priority-status" id="modaal" data-id="'+response.ticket_id+'" data-toggle="modal"><i class="fa fa-pencil"></i></a>');
                 $('#status').html('<button type="button" class="btn bg-gray-active  btn-sm"><span>'+response.ticket.status+'</span></button><a class="pull-right btn btn-lg" href="javascript:;" data-target="#modal-edit-priority-status" id="modaal" data-id="'+response.ticket_id+'" data-toggle="modal"><i class="fa fa-pencil"></i></a>');
