           ...
           @if (count($errors) > 0)
            ...
            <div class="box box-primary">
                ...
                <div class="col-lg-12 top-10px">
                    ...
                    <div class="form-group col-lg-5">
                        <label>Fax</label>
                        {!! Form::input('text','fax',null, ['placeholder'=>"Fax",'class'=>"form-control"]) !!}
                    </div>
                    ...
                    <div class="form-group col-lg-5">
                        ...
                        {!! Form::input('text','emergency_contact_phone',null, ['placeholder'=>"Emergency Contact Phone",'class'=>"form-control"]) !!}
