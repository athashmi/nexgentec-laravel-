        ...
        <div class="row">
            ...
            {!! Form::model($employee, ['route' => ['admin.employee.update', $employee->id], 'method'=>'PUT']) !!}
                ...
                <div class="col-lg-12">
                    <div class="form-group col-lg-5">
                        <label>Phone</label>
                        {!! Form::input('text','phone',null, ['placeholder'=>"Phone",'class'=>"form-control"]) !!}
                    ...
                    <div class="form-group col-lg-5">
                       ...
                       {{--  <select class="form-control multiselect"  name="managed_by">
                            <option value="" > Select Manager</option>
                            @foreach($managers as $manager)
                            <option value="{{$manager->id}}"
                                @if($employee->employee->managed_by==$manager->id))
                            {{'selected="selected"'}} @endif> {{$manager->f_name}} {{$manager->l_name}}</option>
                            @endforeach
                        </select> --}}
                    ...
                    <div class="form-group col-lg-5">
                       ...
                       {{--  <select class="form-control multiselect"  name="role">
                    ...
                    <div class="form-group col-lg-5">
                        ...
                        {{-- <select class="form-control multiselect"  name="pay_type">
                            <option value="">Select Pay Type</option>
                            <option value="salary" @if($employee->employee->pay_type=="salary") {{'selected="selected"'}} @endif>Salary</option>
                    ...
                    <div class="form-group col-lg-5">
                       ...
                       {{--  <select class="form-control multiselect"  name="vacation_yearly">
                            <option value="">Select Vacations</option>
                            @for($i = 0; $i <= 50; $i++)
                            <option value="{{ $i }}" @if($employee->employee->vacation_yearly==$i) {{'selected="selected"'}} @endif>{{ $i }}</option>
                            @endfor
                        </select> --}}
                    </div>
                    <div class="form-group col-lg-5">
                       ...
                       {{--  <select class="form-control multiselect"  name="sick_days_yearly">
                            <option value="">Select Vacations</option>
                            @for($i = 0; $i <= 50; $i++)
                            <option value="{{ $i }}"  @if($employee->employee->sick_days_yearly==$i) {{'selected="selected"'}} @endif>{{ $i }}</option>
                            @endfor
                        </select> --}}
                    </div>
                    <div class="form-group col-lg-5">
                       ...
                       {{--  <select class="form-control multiselect"  name="withholding_tax_rate">
                            <option value="">Select amount</option>
                            @for($i = 0; $i <= 2; $i++)
                            <option value="{{ $i }}"
                                @if($employee->employee->withholding_tax_rate==$i) {{'selected="selected"'}} @endif
                            >{{ $i }}</option>
                            @endfor
                        </select> --}}
                    </div>
                    <div class="form-group col-lg-5">
                       ...
                       {{--  <select class="form-control multiselect"  name="time_zone">
                            <option value="">Select time zone</option>
                            @foreach($time_zones as $value=>$title)
                            <option value="{{ $value }}"
                                @if($employee->employee->time_zone==$value) {{'selected="selected"'}} @endif
                            >{{ $title }}</option>
                            @endforeach
                        </select> --}}
                    </div>
                    ...
                    <div class="form-group col-lg-5">
                        ...
                        {!! Form::input('text','emergency_contact_phone',$employee->employee->emergency_contact_phone, ['placeholder'=>"Emergency Contact Phone",'class'=>"form-control"]) !!}
...
<!-- /#page-wrapper -->
@include('admin.delete_modal_ajax')
@endsection
